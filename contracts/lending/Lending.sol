...
contract Lending is ReentrancyGuard, Ownable {
    ...
    //+-Status of our Usage regarding the available amount to borrow that we have in the Lending Platform:_
    ...
    function healthFactor(address account) public view returns (uint256) {
        /**+-Setting "borrowedValueInEth" and "collateralValueInEth" Values Equal to the Return of
        getAccountInformation(account):_*/
        ...
        /**+-Returns "1" if we already borrowed all the available amount of Assets that we have for Borrowing,
        and returns "100" if No. If you are Below the Health Factor, you Colateral Assets can get Liquidated:_*/
